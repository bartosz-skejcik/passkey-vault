...
//
// The three functions below close the Phase-22-left `TODO(phase-23, WR-09)`
// handoffs in `update`/`delete`/`move_item`: a shared mutation must bump the
...
pub async fn update(
    ...
    // SYNC-04/SYNC-05 (closes this handler's `TODO(phase-23, WR-09)`):
