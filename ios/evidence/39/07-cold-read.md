...
- Server: http://127.0.0.1:8624
- Simulator UDID: 34992BB7-4982-4915-92C7-C7FC987802AF
- Account: pv-39-07-coldread-1787111381@example.invalid
- App Group container (host path): /Users/j5on/Library/Developer/CoreSimulator/Devices/34992BB7-4982-4915-92C7-C7FC987802AF/data/Containers/Shared/AppGroup/1BAFFC1E-B911-473D-8D85-BBA274FAC34A
- Pinned evidence reference (epoch ms): 1787111382068

### Host write digest vs. the reader's digest

| side | SHA-256 |
|---|---|
| host (independently computed over the raw persisted file) | `336d7dd7485411c17be71ae3a2c775410ad691e5225ced363a4a14b5b4db9aa5` |
| extension (the digest `CacheColdReadProbe` computed over the bytes it read) | `336d7dd7485411c17be71ae3a2c775410ad691e5225ced363a4a14b5b4db9aa5` |
...
```
$ xcrun simctl spawn 34992BB7-4982-4915-92C7-C7FC987802AF launchctl list | grep -i cloud.blonie.PasskeyVault   # BEFORE terminate
24055	0	UIKitApplication:cloud.blonie.PasskeyVault[fce7][rb-legacy]
...
```
$ nm /tmp/pv-dd-coldread/Build/Products/Debug-iphonesimulator/PasskeyVault.app/PlugIns/PasskeyVaultAutoFill.appex/PasskeyVaultAutoFill.debug.dylib | grep AppGroupCiphertextCacheStore
000000000000a560 t _$s20PasskeyVaultAutoFill28AppGroupCiphertextCacheStoreC11fileManager33_4376335CCF4A93229568DB803F5122FFLLSo06NSFileK0Cvg
000000000017bcc0 s _$s20PasskeyVaultAutoFill28AppGroupCiphertextCacheStoreC11fileManager33_4376335CCF4A93229568DB803F5122FFLLSo06NSFileK0CvpWvd
000000000000a5c0 T _$s20PasskeyVaultAutoFill28AppGroupCiphertextCacheStoreC11fileManagerACSo06NSFileK0C_tcfC
0000000000205ec4 S _$s20PasskeyVaultAutoFill28AppGroupCiphertextCacheStoreC11fileManagerACSo06NSFileK0C_tcfCTq
000000000000a608 T _$s20PasskeyVaultAutoFill28AppGroupCiphertextCacheStoreC11fileManagerACSo06NSFileK0C_tcfc
... (156 total matching lines)
```
...
FRESHNESS-HOST: Last synced just now
FRESHNESS-EXT: Last synced just now
FRESHNESS-MATCH: SAME
FRESHNESS-SCREENSHOT: ios/evidence/39/39-07-coldread-freshness.png

Both strings are the SAME production formatter (`PvShared/SyncFreshness.describe(syncedAtMs:reference:)`), called independently by the host process and the extension process, against the SAME persisted snapshot and the SAME pinned reference instant (`1787111382068`).

### The control (comparison shown able to say DIFFERENT, D-06/D-08)

The identical capture-and-compare mechanism, re-run with the extension deliberately pointed at a snapshot whose `syncedAtMs` is `1787104182068` (the pinned reference minus two hours) instead of the host's real value:
