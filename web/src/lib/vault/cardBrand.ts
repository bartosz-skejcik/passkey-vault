...
// IIN/BIN prefix ranges (Bartek live-review round 3, TASK 3). Zero-knowledge
// note: this only ever runs client-side over an already-decrypted number the
// user typed; nothing here is sent anywhere.
