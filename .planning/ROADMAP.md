...
- [ ] 28-01-PLAN.md — Direct-share + hidden_password write refusal (extension), dormant provider-ceremony twin
- [ ] 28-02-PLAN.md — SHARE-06 revoke wrappers, dialog, and row wiring (web)
