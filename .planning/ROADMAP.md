...
- [x] 32-02-PLAN.md — Destination-control unit tests + retry-safe create-then-move dispatch test + live SC1 create-mode proof
...
- [x] 32-04-PLAN.md — Live SC3 TOCTOU-refusal proof + live SC4 move-out access-loss proof
...
| 32. Putting Things Into Shared Folders | v0.5 | 4/4 | In Progress|  |
