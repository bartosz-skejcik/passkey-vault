...
- [x] 19-01-PLAN.md — SEC-01/SEC-02: explicit Access-Control-Allow-Headers + concrete-origin-only CORS allowlist (moz-extension://* wildcard removed) + Firefox e2e-firefox lane doc fallout
- [x] 19-02-PLAN.md — SEC-04: shared counter-regression classifier (additive `counter_anomaly_at` column + tracing::warn) across all 3 finish_passkey_authentication call sites
