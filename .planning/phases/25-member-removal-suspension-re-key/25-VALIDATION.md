...
| _pending_ | — | — | KEY-07 | T-25-atomic | Re-key atomic under injected mid-transaction fault | integration (fault injection) | `cargo test -p pv-server --test family_removal -- rolls_back_completely_on_injected_mid_write_fault` | ❌ W0 | ⬜ pending |
